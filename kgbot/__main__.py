...
from kgbot.modules import ALL_MODULES
from kgbot.modules.helper_funcs.chat_status import is_user_admin
from kgbot.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    [
        InlineKeyboardButton(text="➕ ᴀᴅᴅ ᴍᴇ ᴛᴏ ɢʀᴏᴜᴘ ➕", url="http://t.me/KGSuperbot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="⌜sᴏᴜʀᴄᴇ⌟", url=f"https://xhamster.com"),
        InlineKeyboardButton(
            text="⌜ᴍᴜsɪᴄ⌟", url=f"https://kgmusicbot.blogspot.com"
        ),
    ],
    [
...
HELP_STRINGS = """
𝙎𝙀𝙏𝙏𝙄𝙉𝙂𝙎‼️
ᴋʟɪᴄᴋ ᴛᴏᴍʙᴏʟ ᴅɪʙᴀᴡᴀʜ ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴀᴘᴀᴛᴋᴀɴ ᴅᴏᴋᴜᴍᴇɴᴛᴀsɪ ᴛᴇɴᴛᴀɴɢ ᴍᴏᴅᴜʟ ᴛᴇʀsᴇʙᴜᴛ!"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("kgbot.modules." + module_name)
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="ɢʀᴏᴜᴘ", url="t.me/KGSupportgroup")]]
            ),
        )
...
def kgbot_about_callback(update, context):
    ...
    if query.data == "kgbot_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ɢʀᴏᴜᴘ", url="t.me/KGSupportgroup"
                        ),
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            f"\n• Than send `/admincache@KGSuperbot` in that chat to refresh admin list in My database.\n"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="t.me/KGSupportgroup"),
                    InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇs", url="t.me/rakasupport"),
                 ],
                 [
                    InlineKeyboardButton(text="ᴍᴜsɪᴄ ᴍᴀʟᴀᴍ", url="t.me/randomvirtualchat"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ʏᴜɪ", url="t.me/Badboyanim"),
                    InlineKeyboardButton(text="ᴋᴇᴋ", url="t.me/Skuyykek69"),
                 ],
                 [
                    InlineKeyboardButton(text="ᴋɢ", url="t.me/knsgnwn"),
